...
class TagController extends Controller
{
    ...
    {
        $result = $this->tagService->hidFind($hid);
        $resource = new Item($result,new TagTransformer());
        $this->setData($resource);
        return $this->response();
    }
    ...
    {
        $this->tagService->hidUpdate($request,$hid);
        $resource = new Item($this->tagService->hidFind($hid),new TagTransformer());
        $this->setData($resource);
        return $this->response();
    }
    ...
    {
        $result = $this->tagService->hidDelete($hid);
