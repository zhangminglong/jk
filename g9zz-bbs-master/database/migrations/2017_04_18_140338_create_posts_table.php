...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->string('user_hid')->comment('作者HID')->default('')->index();
            $table->string('node_hid')->comment('节点HID')->default('')->index();
            ...
            $table->timestamp('last_reply_activated_at')->default(DB::raw('CURRENT_TIMESTAMP'))->nullable()->comment('最后回复的时间');
