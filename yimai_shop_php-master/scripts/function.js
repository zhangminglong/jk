...
function updateNumber(id, status)
{
	var price = document.getElementById("price_id_" + id).getElementsByTagName("input")[0].value;
	//var priceBox = document.getElementById("price_id_" + id).getElementsByTagName("span")[0].innerHTML;
	var  priceBox = document.getElementById("count_id_" + id).getElementsByTagName("span")[0];
	var  priceInput = document.getElementById("count_id_" + id).getElementsByTagName("input")[0];
	var	 allPriceBox = document.getElementById("allCount_id_" + id).getElementsByTagName("span")[0];
	var number = document.getElementById("number_id_" + id);
	//alert(priceBox);
	//alert(price);
	//alert(spanBox[0].innerHTML);
	if(status) {
	...
	priceInput.value = price * number.value;
	allPriceBox.innerHTML = "￥" + price * number.value;
}
